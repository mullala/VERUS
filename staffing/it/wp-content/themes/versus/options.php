...
//////////////////////////////////////////////External URL SETTINGS START////////////////////////////////////////////////////////////////////
    $options[] = array(
		'name' => __('External URL Settings', 'options_check'),
		'type' => 'heading');
	$options[] = array(
		'name' => __('Job Search URL:', 'options_check'),
		'desc' => __('Enter Your Job Search Page URL', 'options_check'),
		'id' => 'jsu_link',
		'std' => 'http://www.verusstaffing.com/JobSearch/VERUSJobSearch.htm',
		'type' => 'text');
		
	$options[] = array(
		'name' => __('Client Login URL:', 'options_check'),
		'desc' => __('Enter Your Client Login Page URL', 'options_check'),
		'id' => 'cli_link',
		'std' => 'http://www.verusstaffing.com/accts/VERUS%20Client.htm',
		'type' => 'text');
	
	$options[] = array(
		'name' => __('Candidate Login URL:', 'options_check'),
		'desc' => __('Enter Your Candidate Login Page URL', 'options_check'),
		'id' => 'canli_link',
		'std' => 'http://www.verusstaffing.com/accts/VERUS%20Candidate.htm',
		'type' => 'text');
		
	$options[] = array(
		'name' => __('New Client URL:', 'options_check'),
		'desc' => __('Enter Your New Client Page URL', 'options_check'),
		'id' => 'ncpu_link',
		'std' => 'http://www.verusstaffing.com/accts/VERUS%20Client.htm',
		'type' => 'text');
	
	$options[] = array(
		'name' => __('New Candidate URL:', 'options_check'),
		'desc' => __('Enter Your New Candidate Page URL', 'options_check'),
		'id' => 'ncpu_link',
		'std' => 'http://www.verusstaffing.com/accts/VERUSNewCandidate.htm',
		'type' => 'text');
//////////////////////////////////////////////External URL SETTINGS END////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////HEADER SETTINGS START////////////////////////////////////////////////////////////////////
	$options[] = array(
	 ...
	 $options[] = array(
		...
		'desc' => __('Image Size should be 260x80 PX', 'options_check'),
		'id' => 'logo_uploader',
		'type' => 'upload');
	...
	$options[] = array(
		'name' => __('Phone No:', 'options_check'),
		'desc' => __('Enter Phone No.', 'options_check'),
		'id' => 'phone_no',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('E-mail:', 'options_check'),
		'desc' => __('Enter E-mail Address', 'options_check'),
		'id' => 'email_address',
		'std' => '',
		'type' => 'text');
//////////////////////////////////////////////HEADER SETTINGS END////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////FOOTER SETTINGS START////////////////////////////////////////////////////////////////////
	...
	$options[] = array(
		...
		'type' => 'heading');
	$options[] = array(
		'name' => __('Content Below The Home Page Banner', 'options_check'),
		//'desc' => sprintf( __( 'Enter Content :', 'options_check' ), '' ),
		'id' => 'footer_editor',
		'type' => 'editor',
		'settings' => $wp_editor_settings );
	
	$options[] = array(
		'name' => __('Footer Text 1', 'options_check'),
		'desc' => __('Enter Footer Text 1', 'options_check'),
		'id' => 'copyright_text1',
		'std' => 'National Womens Business Owners Corporation.',
		'type' => 'text');
	$options[] = array(
		'name' => __('Footer Text 1 URL:', 'options_check'),
		'desc' => __('Enter Your Footer Text 1 Page URL', 'options_check'),
		'id' => 'copyright_text1_url',
		'std' => 'http://www.verusstaffing.com/Docs/NWBOCweb.jpg',
		'type' => 'text');
		
	$options[] = array(
		'name' => __('Footer Text 2', 'options_check'),
		'desc' => __('Enter Footer Text 2', 'options_check'),
		'id' => 'copyright_text2',
		'std' => 'Womens Business Enterprise National Council',
		'type' => 'text');
	$options[] = array(
		'name' => __('Footer Text 2 URL:', 'options_check'),
		'desc' => __('Enter Your Footer Text 2 Page URL', 'options_check'),
		'id' => 'copyright_text2_url',
		'std' => 'http://www.verusstaffing.com/Docs/WBENCweb.jpg',
		'type' => 'text');
		
	$options[] = array(
		'name' => __('Footer Copyright Text', 'options_check'),
		'desc' => __('Enter Copyright Text ', 'options_check'),
		'id' => 'copyright_text',
		'std' => '© 2012 Descord Magazine. All rights reserved',
		'type' => 'text');
